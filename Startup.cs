...
namespace Parks
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IParksDatabaseSettings>(
                sp => sp.GetRequiredService<IOptions<ParksDatabaseSettings>>().Value);

            services.AddSingleton<INationalParkRepository, NationalParkRepository>();
